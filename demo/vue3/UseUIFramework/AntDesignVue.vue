<template>
  <div class="p-20px">
    <a-form ref="listFilterRef" layout="inline" :model="list.filter">
    ...
    },]" :dataSource="list.data" :loading="list.loading">
      <template #action="{ row }">
    ...
    <a-modal v-model:visible="form.show" :title="formTitle">
      <a-form ref="formRef" :model="form.data" v-loading="form.loading">
